...
def get_overlap():
    ...
    """
    fn = "../../feature_overlap/_m/shared_genes.tsv"
...
def get_res_df(fnc):
    ...
    """
    return get_residualized()[list(fnc().index)]
...
def main():
    pp = plot_corr(get_predictive)
    qq = plot_corr(get_overlap)
    save_plot(pp, "predictive_variation")
    save_plot(qq, "shared_variation")
