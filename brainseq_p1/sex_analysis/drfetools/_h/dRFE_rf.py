...
in BrainSeq Phase 1, control only or MDD only.
This is a poly-A enrichned RNA-seq data.
"""
import numpy as np
import pandas as pd
...
def rf_run(X_train, X_test, Y_train, Y_test, fold_num, outdir,
    ...
    output['test_roc'] = roc_auc_score(Y_test, labels_pred)
...
def main_loop(args):
    ...
    fields = ['n_features_all_features', 'train_acc_all_features',
              ...
              'n_features', 'train_nmi', 'train_acc', 'train_roc', 'test_nmi',
              'test_acc', 'test_roc', 'n_redundant', 'test_nmi_redundant',
              'test_acc_redundant', 'test_roc_redundant']
...
def main():
    ...
    parser.add_argument('--diagnosis', type=str, default="Control")
